...
if (-not (Test-Path -LiteralPath $pluginIni)) {
    ...
    $defaults = @(
        ...
        @{ Section = 'Extensions'; Key = 'TextExtensions'; Value = 'md;markdown;json;xml;ps1;psm1;psd1;html;htm;mxl;sarif'; Comment = '; Other text/code extensions' }
    )
...
function Get-DetectString([string] $iniPath) {
    ...
    $all += (& $get 'Extensions' 'TextExtensions' 'md;markdown;json;xml;ps1;psm1;psd1;html;htm;mxl;sarif')
