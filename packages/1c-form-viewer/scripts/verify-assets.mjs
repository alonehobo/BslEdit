...
const expected = [...browserAssets, ...platformIcons, ...stdPictures, 'agent-viewer.css', 'agent-viewer.js', 'session-annotations.css', 'session-annotations.js', 'index.html'].sort();
